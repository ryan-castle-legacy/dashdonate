			...
			<div class='row w-100'>
				<div class='col-12'>
					<div class='card'>
						...
						{{-- <pre>{{ var_dump($charity->details) }}</pre> --}}
				...
				<div class='col px-0 d-flex mb-4 justify-content-center'>
					<div class='alert mb-1 alert-info w-100 mx-3'>
						<p class='m-0 p-0'>
							...
							Once you're sure that your charity's details are correct you can publish your charity.
						</p>
						<a class='btn btn-primary btn-sm m-0' data-toggle='modal' data-target='#modals-charities-details_confirm'><i class='fas fa-check m-0'></i>&nbsp; Publish charity</a></small>
					</div>
				</div>
			@else
				<div class='col d-flex mb-4 justify-content-end'>
					<a class='btn btn-primary btn-sm m-0' data-toggle='modal' data-target='#modals-charities-details_confirm'><i class='fas fa-save m-0'></i>&nbsp; Update charity details</a></small>
				</div>
			@endif
		@endif
