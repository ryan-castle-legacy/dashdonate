...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'firstname', 'lastname', 'email', 'password', 'user_role', 'email_confirm_code', 'is_admin', 'stripe_customer_id', 'needs_password_reset',
    ];
	...
	public function isAdmin() {
		if ($this->getAttribute('email') == 'ryan@dashdonate.org') {
			return true;
		} else {
	...
	// Get user's role in a charity
	public function getRoleInCharity($charity_slug) {
		$role = API::getRoleInCharity($charity_slug, $this->id);
		return $role;
	}
