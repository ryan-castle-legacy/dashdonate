		...
		<div class='container py-5'>
			...
			<div class='row px-0 py-3 justify-content-between key_point'>
				...
				<div class='col-8'>
					...
					<p>We know it can be annoying to get pestered by marketing emails, so we've locked all charity updates into a simple news feed on DashDonate - you receive donation information when you want it, not when you don't.</p>
				</div>
			</div>
		</div>
	</div>
